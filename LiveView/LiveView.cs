...
{
    internal partial class LiveViewForm : Form
    {
        public LiveViewForm(Device device)
        {
            InitializeComponent();
        ...
        /// </summary>
        public long MinUpdateInterval = 100;
        public void UpdateInfo(params string[] infoBlocks)
        {
            try
            {
                BeginInvoke((MethodInvoker)delegate
                {
                    ...
                    if (_updateWatch.IsRunning && _updateWatch.ElapsedMilliseconds < MinUpdateInterval)
                    {
                        return;
                    }
